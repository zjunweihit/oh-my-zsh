...
* zjunweihit
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/zjunweihit/oh-my-zsh/master/tools/install.sh)"
```
...
* zjunweihit
```shell
sh -c "$(wget https://raw.githubusercontent.com/zjunweihit/oh-my-zsh/master/tools/install.sh -O -)"
```
